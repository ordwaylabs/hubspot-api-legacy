describe HubspotLegacy::Engagement do
  ...
  describe 'EngagementNote' do
    ...
    describe ".associate!" do
      ...
      let(:contact) { HubspotLegacy::Contact.create!("newcontact#{Time.now.to_i}@hsgem.com") }
      subject { HubspotLegacy::Engagement.associate!(engagement.id, 'contact', contact.vid) }

      it 'associate an engagement to a resource' do
        subject
        found_by_contact = HubspotLegacy::Engagement.find_by_contact(contact.vid)
