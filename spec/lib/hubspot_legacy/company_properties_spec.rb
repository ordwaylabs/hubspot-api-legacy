describe HubspotLegacy::CompanyProperties do
  ...
  describe 'Properties' do
    describe '.all' do
      context 'with no filter' do
        ...
        it 'should return all properties' do
          expect(HubspotLegacy::CompanyProperties.all).to eql(example_properties)
        end
      end
      ...
      context 'with included groups' do
        ...
        it 'should return properties for the specified group[s]' do
          response = HubspotLegacy::CompanyProperties.all({}, { include: groups })
      ...
      context 'with excluded groups' do
        ...
        it 'should return properties for the non-specified group[s]' do
          response = HubspotLegacy::CompanyProperties.all({}, { exclude: groups })
    ...
    let(:valid_params) { params.select { |k, _| HubspotLegacy::CompanyProperties::PROPERTY_SPECS[:field_names].include?(k) } }
    ...
    describe '.create!' do
      context 'with no valid parameters' do
        ...
        it 'should return nil' do
          expect(HubspotLegacy::CompanyProperties.create!({})).to be(nil)
        end
      end
      ...
      context 'with all valid parameters' do
        ...
        it 'should return the valid parameters' do
          response = HubspotLegacy::CompanyProperties.create!(params)
    ...
    describe '.update!' do
      context 'with no valid parameters' do
        ...
        it 'should return nil ' do
          expect(HubspotLegacy::CompanyProperties.update!(params['name'], {})).to be(nil)
        end
      end
      ...
      context 'with mixed parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          response = HubspotLegacy::CompanyProperties.update!(params['name'], params)
          valid_params.each { |k, v| expect(response[k]).to eq(v) }
        end
      end
    end
    ...
    describe '.delete!' do
      ...
      context 'with existing property' do
        ...
        it 'should return nil' do
          expect(HubspotLegacy::CompanyProperties.delete!(name)).to eq(nil)
        end
      end
      ...
      context 'with non-existent property' do
        ...
        it 'should raise an error' do
          expect { HubspotLegacy::CompanyProperties.delete!(name) }.to raise_error(HubspotLegacy::RequestError)
        end
      end
    end
  end
    ...
    describe '.groups' do
      context 'with no filter' do
        ...
        it 'should return all groups' do
          expect(HubspotLegacy::CompanyProperties.groups).to eql(example_groups)
        end
      end
      ...
      context 'with included groups' do
        ...
        it 'should return the specified groups' do
          response = HubspotLegacy::CompanyProperties.groups({}, { include: groups })
      ...
      context 'with excluded groups' do
        ...
        it 'should return groups that were not excluded' do
          response = HubspotLegacy::CompanyProperties.groups({}, { exclude: groups })
    ...
    describe '.create_group!' do
      ...
      context 'with mixed parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          expect(HubspotLegacy::CompanyProperties.same?(response, params)).to be_true
        end
      end
      ...
      context 'with some valid parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          expect(HubspotLegacy::CompanyProperties.same?(response, sub_params)).to be_true
        end
      end
    end
