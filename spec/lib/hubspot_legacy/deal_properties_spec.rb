    ...
    describe '.create!' do
      ...
      context 'with all valid parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          expect(HubspotLegacy::DealProperties.same?(params, response)).to be_true
        end
      end
    end
    ...
    describe '.update!' do
      ...
      context 'with mixed parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          expect(HubspotLegacy::DealProperties.same?(response, params)).to be_true
        end
      end
    end
    ...
    describe '.create_group!' do
      ...
      context 'with some valid parameters' do
        ...
        it 'should return the valid parameters' do
          ...
          expect(HubspotLegacy::DealProperties.same?(response, sub_params)).to be_true
        end
      end
    end
